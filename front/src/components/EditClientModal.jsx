...
export const ModalFormEditClient = ({
  client,
  modal,
  handleChange,
  closeModal,
      ...
      >
        ...
        <label className="block mb-2">
          ...
          <input
            ...
            value={client.email}
            onChange={handleChange}
            className="w-full p-1 mb-5 pl-2 font-medium border rounded-lg dark:bg-[#27272a] dark:focus:bg-[#232321] focus:bg-gray-100 bg-gray-50 dark:text-gray-300 text-gray-900 outline-none border-1 border-gray-500 active:border-blue-500 focus:border-blue-500 transition-colors"
          />
        </label>
